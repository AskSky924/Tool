...
import com.jingqubao.tool.view.CompassView;
...
public class CompassActivity extends Activity {
    ...
    private void initResources() {
        ...
        mLngLat = (TextView) findViewById(R.id.compass_lng_lat);
        mAddress = (TextView) findViewById(R.id.compass_address);
    }
    ...
    private void initServices() {
        ...
        utils.startLocation(1000, new LocationUtils.OnLocationListener() {
            @Override
            public void onSuccess(AMapLocation location) {
                ...
                String ll = "经度：" + lonlat.longitude + "   纬度：" + lonlat.latitude;
                mLngLat.setText(ll);
